...
from .views import set_or_edit_content,upload_file,update_text,get_text,download_base_file, check_file_status, download_txt_file, my_files,search_files,delete_file,verify_file
...
urlpatterns = [
    ...
    path('description/<uuid:uuid>/', set_or_edit_content, name='set_or_edit_content')
