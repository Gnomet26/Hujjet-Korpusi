...
from .views import get_text,logout_admin, download_any_base_file, download_any_txt_file, register_admin, login_admin, user_list, file_list,check_file,statistika,search_user,search_file, delete_user, create_user,delete_file, change_user, download_merged_txt_files
